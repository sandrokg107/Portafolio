    ...
    <div className="max-w-6xl mx-auto px-6">
      <div className="text-center mb-16">
        ...
        <p className="text-slate-400 max-w-2xl mx-auto">
          Te ayudo a construir tu presencia online con dedicación y precios accesibles.
        </p>
      </div>
      <div className="grid md:grid-cols-3 gap-8">
        {services.map((service, index) => (
          <div
            key={index}
            className="bg-slate-900/50 p-8 rounded-2xl border border-slate-800 hover:border-blue-500/30 hover:bg-slate-900 transition-all duration-300 group"
          >
            ...
            <div className="pt-4 border-t border-slate-800 flex justify-between items-center">
              ...
              >
                Consultar <ChevronDown size={14} className="-rotate-90" />
              </a>
            </div>
          </div>
        ))}
